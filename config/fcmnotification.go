...
func initializeFirebase() {
	...
	serviceAccountPath := "config/rentxpert-a987d-firebase-adminsdk-fbsvc-5d2eb5f572.json"
...
func sendPushOnly(fcmToken, title, body, conversationId, senderId string) {
	...
	saKey, err := os.ReadFile("config/rentxpert-a987d-firebase-adminsdk-fbsvc-5d2eb5f572.json")
	if err != nil {
